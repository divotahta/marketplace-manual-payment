                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between mb-8">
                        <div class="flex items-center mb-4 md:mb-0">
                            <div class="relative">
                                ...
                                @else
                                    <div
                                        class="w-24 h-24 rounded-full bg-indigo-500 flex items-center justify-center text-white text-3xl font-bold">
                            ...
                            <div class="ml-6">
                                ...
                                <p class="text-sm text-gray-500">Admin sejak {{ $user->created_at->format('d M Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
